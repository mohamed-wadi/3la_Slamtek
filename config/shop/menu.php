...
/**
 * Configuration personnalisée pour le menu client.
 * Ce fichier remplace la configuration par défaut de Bagisto.
 */
return [
    [
        'key'   => 'account',
    ...
    // L'option "Downloadable Products" a été délibérément supprimée ici
    [
        'key'   => 'account.reviews',
