...
>
    ...
    <body dir="{{ core()->getCurrentLocale()->direction }}">
        <!-- Logo dans le coin supérieur -->
        <div class="logo-container {{ core()->getCurrentLocale()->direction }}">
            <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/storage/logo/logo.png'))) }}" style="width: 70px; height: 60px;"/>
        </div>
